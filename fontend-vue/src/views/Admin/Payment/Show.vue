<template v-if="id">
    <div class="modal fade" id="showModalbrand" tabindex="-1" aria-labelledby="showModalbrand" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-success">
                    <h1 class="modal-title h3 text-light">Show brand</h1>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="mb-3">
                            <label class="col-form-label fw-bold text-dark">Categories:</label>
                            <input v-if="data" :value="data.categories" type="text" class="form-control" disabled>
                        </div>
                        <div class="mb-3">
