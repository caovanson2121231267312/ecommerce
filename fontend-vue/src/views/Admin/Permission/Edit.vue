<template v-if="id">
    <div class="modal fade" id="editModalpermission" tabindex="-1" aria-labelledby="editModalpermission" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-success">
                    <h3 class="modal-title h3 text-light">Edit Permission</h3>
...
export default {
    ...
    methods: {
        ...
        async sendData() {
            ...
            try {
                const data = await api.post('api/admin/permissions/' + this.id, form, {
                    'Content-Type': 'application/json',
                    'Authorization': 'Bearer ' + this.auth.access_token
                })
                await alert('success', 'top-center', 'Sửa thành công permission.');
                this.loadData()
