...
!(function (o) {
    function e() {
        ...
        _toConsumableArray(document.querySelectorAll('[data-bs-toggle="popover"]')).map(function (
            e
        ) {
            return new bootstrap.Popover(e)
        }),
            _toConsumableArray(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(
                function (e) {
        ...
        o('.side-nav').length &&
            ...
            o('.side-nav a').each(function () {
                ...
                this.href == e &&
                    ...
                    'sidebar-menu' !==
                        (e = o(this).parent().parent().parent().parent().parent().parent()).attr(
                            'id'
                        ) && e.addClass('show'),
                    o(this)
                        .parent()
    ...
    e(),
        ...
        o('.dropdown-menu a.dropdown-toggle').on('click', function () {
            ...
            return (
                e.removeClass('show'), e.parent().find('.dropdown-toggle').removeClass('show'), !1
            )
        }),
        t(),
        o('.navbar-nav').length &&
                ...
                value: function () {
                    ...
                    e &&
                        ...
                        document.querySelectorAll('.button-sm-hover').forEach(function (e) {
                            e.addEventListener('click', function () {
                                var e = n.config.sidenav.size
                                'sm-hover-active' === n.html.getAttribute('data-sidenav-size', e)
                ...
                value: function () {
                    ...
                    s &&
                        ((e = document.querySelector(
                            'input[type=radio][name=data-layout][value=' + s.nav + ']'
                        )),
                        (t = document.querySelector(
                            'input[type=radio][name=data-theme][value=' + s.theme + ']'
                        )),
                        (n = document.querySelector(
                            'input[type=radio][name=data-layout-mode][value=' + s.layout.mode + ']'
                        )),
                        ...
                        (o = document.querySelector(
                            'input[type=radio][name=data-menu-color][value=' + s.menu.color + ']'
                        )),
