...
!(function (t, e) {
    ...
    class U extends F {
        ...
        _eventIsPointerPenTouch(t) {
            return (
                this._supportPointerEvents && ('pen' === t.pointerType || 'touch' === t.pointerType)
            )
        }
        static isSupported() {
...
!(function (t, e) {
            ...
            return (
                ...
                n.global
                    ? i
                        ? (t[e] = r)
                        : a(e, r)
                    : (n.unsafe ? t[e] && (i = !0) : delete t[e], i ? (t[e] = r) : Et(t, e, r)),
                t
            )
        },
        qt = g({}.toString),
    ...
    X ||
        Ht(Object.prototype, 'toString', Zt, {
            unsafe: !0
        })
    var te = {
            CSSRuleList: 0,
        ...
        On = function (t, e, r, n, i, o, s) {
            ...
            if (
                (g &&
                    ...
                    a.next &&
                    (on(a) !== mn && (gn ? gn(a, mn) : T(a[En]) || Ht(a, En, wn)), fn(a, f, !0)),
                bn &&
                    'values' == i &&
                    p &&
                    'values' !== p.name &&
            ...
            Vo.forEach(function (e) {
                e.activeTargets.splice(0, e.activeTargets.length),
                    ...
                    e.observationTargets.forEach(function (r) {
                        r.isActive() &&
                            (cs(r.target) > t ? e.activeTargets.push(r) : e.skippedTargets.push(r))
                    })
            })
        },
        fs = function () {
    ...
    ;(Qs || ta || Zs || Fs || $s) &&
        (Ys = function (t) {
            ...
            if (f)
                return (
                    (f.lastIndex = c.lastIndex), (e = rt(Ys, f, u)), (c.lastIndex = f.lastIndex), e
                )
            var h = l.groups,
                d = Zs && c.sticky,
                p = rt(Ns, c),
